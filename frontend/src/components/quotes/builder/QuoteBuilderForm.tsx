            ...
            <div className="space-y-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <Button size="sm" variant="secondary" onClick={() => addItem(1)} className="bg-white shadow-sm border-gray-200 hover:bg-gray-50">+ Horas</Button>
                        <Button size="sm" variant="secondary" onClick={() => addItem(3)} className="bg-white shadow-sm border-gray-200 hover:bg-gray-50">+ Fijo</Button>
                        <Button size="sm" variant="secondary" onClick={() => addItem(4)} className="bg-white shadow-sm border-gray-200 hover:bg-gray-50">+ Recurrente</Button>
                    </div>
                </div>
