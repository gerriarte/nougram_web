        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-6 md:flex-row text-xs lg:text-sm text-slate-500">
          <div className="flex items-center">
            <Link to="/" onClick={scrollToTop}>
              <img src="/logo-nougram.png" alt="Nougram" className="h-8 w-auto object-contain" />
            </Link>
          </div>
          <div>
          ...
          <div className="flex gap-6">
            <Link to="/blog" className="hover:text-brand-600 transition-colors">{COPY.nav.blog}</Link>
            <Link to="/docs" className="hover:text-brand-600 transition-colors">{COPY.nav.docs}</Link>
            <Link to="/terminos" className="hover:text-brand-600 transition-colors">{COPY.hero.terms}</Link>
            <a href="#" className="hover:text-brand-600 transition-colors">{COPY.nav.contact}</a>
          </div>
        </div>
      </div>
    </footer>
