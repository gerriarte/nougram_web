          ...
          <div>
            ...
            <div className="space-y-6 lg:space-y-8">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-lg lg:text-xl font-semibold mb-2 text-white">{COPY.credibilityExtra.techFoundation}</h4>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-lg lg:text-xl font-semibold mb-2 text-white">{COPY.credibilityExtra.mutualValue}</h4>
                  <p className="text-sm lg:text-base text-slate-400 leading-relaxed">
             ...
             <div className="relative bg-dark-800 border border-white/10 p-6 lg:p-8 rounded-xl shadow-2xl">
                ...
                <div className="space-y-2 lg:space-y-3 font-mono text-xs lg:text-sm text-slate-300">
                   ...
                   <div className="text-green-400 mt-4">
                      {">"} {COPY.credibilityExtra.recommendation}
                   </div>
                </div>
             </div>
          </div>
